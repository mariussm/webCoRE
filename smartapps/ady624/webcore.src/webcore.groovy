...
private static Map virtualCommands() {
	...
	return [
		...
		httpRequestExtended			: [ n: "Make a web request (extended)",		a: true, 	i: "anchor",		d: "Make a {1} request to {0} with type {2}{3}",				        p: [[n:"URL", t:"uri"],[n:"Method", t:"enum", o:["GET","POST","PUT","DELETE","HEAD","PATCH"]],[n:"Content-Type", t:"string"],[n:"Body", t:"string"],[n:"Headers", t:"string"]],	],
